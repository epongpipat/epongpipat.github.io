...
format:
  html:
    ...
    code-fold: show
    warning: false
categories: [general linear model (GLM), gradient descent, R, statistics]
...
For a review of matrix multiplication, check out my [previous blog post](../posts/solving-ols-regression-using-matrix/index.html).
