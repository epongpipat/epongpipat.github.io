...
pubs2html <- function(data) {
  ...
  for (i in 1:nrow(data)) {
    ...
    # reference <- glue("{reference}. <br>[<a href='{pubs$google_scholar}' target='_blank'>Google Scholar</a>]")
    # reference <- glue("{reference} [PMID: <a href='https://pubmed.ncbi.nlm.nih.gov/{pubs$pmid}' target='_blank'>{pubs$pmid}</a>]")
