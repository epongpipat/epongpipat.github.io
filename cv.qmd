...
<link href="site_libs/font-awesome-5.1.0/css/all.css" rel="stylesheet" /> <link href="site_libs/font-awesome-5.1.0/css/v4-shims.css" rel="stylesheet" />
...
::: divTableCellInfo
<B>Ph.D. Student, Cognition and Neuroscience</B> (2017 - Present) <BR> The University of Texas at Dallas <BR> Advisors: Dr. Karen M. Rodrigue & Dr. Kristen M. Kennedy
:::
:::::
...
::: divTableCellInfo
<B>M.A., Psychology</B> (2016) <BR> San Diego State University <BR> Advisor: Dr. Claire Murphy <BR> Thesis: Altered Functional Connectivity and Eating Disinhibition in Individuals with Metabolic Syndrome https://digitalcollections.sdsu.edu/do/19d8c36d-c6ad-432b-ac37-a885224821b5
:::
:::::
...
::: divTableCellInfo
<B>B.A., Psychology</B> (2012) <BR> California State University, Northridge <BR> Advisor: Dr. Jose P. Abara
:::
:::::
::::::::::::
:::::::::::::
...
::: divTableCellInfo
<B>Graduate Research Assistant</B> (2017 - Present) <BR>Cognitive Neuroscience of Aging Laboratory <BR>Center for Vital Longevity <BR>School of Behavioral and Brain Sciences <BR>The University of Texas at Dallas
:::
:::::
...
::: divTableCellInfo
<B>Graduate Research Assistant</B> (2014 - 2016) <BR>Lifespan Human Senses Laboratory <BR>Department of Psychology <BR>San Diego State University
:::
:::::
...
::: divTableCellInfo
<B>Undergraduate Research Assistant</B> (2011 - 2013) <BR>Neuroscience Laboratory <BR>Department of Psychology <BR>California State University, Northridge
:::
:::::
::::::::::::
:::::::::::::
...
::::: divTableCellInfo
<B>Graduate Teaching Assistant</B> (2017 - 2019) <BR>The University of Texas at Dallas <BR>1. Statistics for Psychology, ACN6312/HCS6312 (Spring 2019) <BR>

::: divIndent
Under the supervision of Dr. Nancy Juhn
:::

<BR>2. Statistics for Psychology, PSY2317 (Fall 2017, Spring 2018, Fall 2018) <BR>
...
::::: divTableCellInfo
<B>Graduate Teaching Assistant</B> (2014 - 2016) <BR>San Diego State University <BR>1. Advanced Statistics in Psychology, PSY670A/B (Fall 2015, Spring 2016) <BR>

::: divIndent
Under the supervision of Dr. Melody Sadler
:::

<BR>2. Statistical Methods in Psychology Laboratory, PSY280L (Fall 2014, Spring 2015) <BR>

::: divIndent
Under the supervision of Dr. Melody Sadler, Dr. Amy Spilkin, and Dr. Dale Glaser
:::
:::::
:::::::
:::::::::::::
...
talks <- tribble(~Date, ~Description, ~Location, ~Links,
...
total_award <- sum(df_honors_awards$Award, na.rm = TRUE)
...
# df_honors_awards %>%
#   gt() %>%
#   summary_rows(columns = 'Award',
#                fns = list(Total = 'sum_na')) %>%
#   fmt_currency(columns = 'Award', decimals = 0) %>%
#   fmt_missing(columns = 'Award', missing_text = '-')
df_honors_awards %>%
  mutate(Award = ifelse(is.na(Award), '', glue("${Award}"))) %>%
  # mutate(Award = glue("${Award}")) %>%
  kable(., "html") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>%
  column_spec(1, width = "150px") %>%
  footnote(., general = glue("Total: ${total_award}"))
```
