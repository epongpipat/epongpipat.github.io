...
talks <- tribble(~Date, ~Description, ~Location,
                 ...
                 "2019-09", "Assisted in an introduction to Git/GitHub Workshop with Dr. Micaela Chan <br><a href='https://gitbookdown.site' target='_blank'><i class='fas fa-book'></i></a> &#8201 <a href='https://github.com/mychan24/git_github_workshop' target='_blank'><i class='fab fa-github'></i></a>", "Center for Vital Longevity, UT Dallas",
