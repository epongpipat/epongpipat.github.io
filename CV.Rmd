...
<BR>The University of Texas at Dallas
<BR>Statistics for Psychology, PSY2317 (Fall 2017, Spring 2018, Fall 2018)
...
<div class="divReferences">
```{r posters, warning = F, message = F, fig.width = 3, fig.height = 2, fig.asp = T, dev='svg'}
...
ggplot(poster_summary, aes(x = Year, y = Frequency)) +
  geom_line(color = "#106a8c") +
  geom_point(color = "#106a8c") +
  theme_classic() +
  labs(subtitle = paste("Average Per Year:",poster_mean_per_year,"±",poster_se_per_year))
```
